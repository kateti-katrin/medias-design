...
const DEMO = [
  ...
  { id: 5, color: '#d4b07a', tag: 'логотип',      note: 'Тонкий моноширинный логотип бренда одежды' },
  { id: 6, color: '#4a3d4f', tag: 'иллюстрация',  note: 'Векторная серия для главной — лица без черт' },
  { id: 7, color: '#8a9d8e', tag: 'лендинг',      note: 'Сетка из 3 колонок, плюс крупная типографика' },
  { id: 8, color: '#b58968', tag: 'упаковка',     note: 'Шоколад с фольгой и тиснением — текстура' }
]
